...
next_state(optional_puzzle, b, ingredient_c_found).
...
display_intro :-
    ...
    write('the village elder who has fallen gravely ill.'), nl, nl,
    write('Explore the lab, gather the necessary ingredients,'), nl,
    write('and follow a recipe to create the potion.'), nl, nl.
...
show_state(table) :-
    ...
    write('Go back to exploring...'), nl.
show_state(painting) :-
    write('There is a safe here. Find the combination?'), nl,
    write('Go back to exploring...'), nl.
show_state(recipe_found) :-
    write('You found the recipe! Proceed to the next stage: Ingredient Gathering'), nl,
    write('Do you want to...'), nl,
    write('(a) Proceed to Ingredient Gathering'), nl,
    write('(q) Quit the program'), nl.
show_state(ingredient_gathering) :-
    write('You have the recipe. You need to find the following ingredients: A, B, and C. You have 10 turns left.'), nl,
...
show_state(potion_crafting) :-
    write('Follow the recipe to create the potion. You need to mix the ingredients in the right order and measure the right amounts.'), nl,
